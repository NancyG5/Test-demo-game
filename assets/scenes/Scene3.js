class Scene3 extends Phaser.Scene {
    ...
    create() {
      ...
      this.girl =
        dress === "dress1"
          ? this.add.image(300, 465, "Lexi-dress1").setAlpha(0)
          : this.add.image(300, 465, "Lexi-dress2").setAlpha(0);
      ...
      this.choose = this.add.image(300, 35, "Choose-bag").setAlpha(0);
      ...
      this.bag1.setInteractive().on(
        ...
        function (pointer, localX, localY, event) {
          this.bagsFn("Lexi-dress1-bag1", "Lexi-dress2-bag1");
        },
        this
      );
      ...
      this.bag2.setInteractive().on(
        "pointerdown",
        function (pointer, localX, localY, event) {
          this.bagsFn("Lexi-dress1-bag2", "Lexi-dress2-bag2");
        },
        this
      );
      ...
      this.accessory1.setInteractive().on(
        ...
        function (pointer, localX, localY, event) {
          this.accessoriesFn(
            "Lexi-dress1-bag1-accessory1",
            "Lexi-dress1-bag2-accessory1",
            "Lexi-dress2-bag1-accessory1",
            "Lexi-dress2-bag2-accessory1"
          );
        },
        this
      );
      ...
      this.accessory2.setInteractive().on(
        ...
        function (pointer, localX, localY, event) {
          this.accessoriesFn(
            "Lexi-dress1-bag1-accessory2",
            "Lexi-dress1-bag2-accessory2",
            "Lexi-dress2-bag1-accessory2",
            "Lexi-dress2-bag2-accessory2"
          );
        },
        this
      );
    ...
    bagsFn(value1, value2) {
      ...
      this.choose = this.add.image(300, 35, "Choose-accessory").setAlpha(0);
    ...
    accessoriesFn(value1, value2, value3, value4) {
      ...
      this.choose.setAlpha(0);
      this.choose = this.add.image(300, 35, "Choose-place").setAlpha(0);
    ...
    placesFs(bg) {
      this.count = 200;
      this.man = this.add.image(300, 465, "Paul").setAlpha(0).setDepth(1);
      this.textMan = this.add
        .image(300, 500, "PaulText2")
        .setDepth(3)
        .setAlpha(0);
      this.btn = this.add.image(300, 800, "PlayNow").setDepth(4).setAlpha(0);
