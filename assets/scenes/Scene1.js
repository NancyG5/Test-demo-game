class Scene1 extends Phaser.Scene {
    ...
    create() {
      this.bg = this.add
        ...
        .setTint(0xffffff)
        .setAlpha(0.4);
      this.man = this.add.image(-100, 450, "Paul");
      this.textMan = this.add.image(300, 500, "PaulText1").setAlpha(0);
      this.girl = this.add.image(-300, 450, "Lexi1");
      this.textGirl = this.add.image(300, 500, "LexiText").setAlpha(0);
