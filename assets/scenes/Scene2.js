class Scene2 extends Phaser.Scene {
    ...
    create() {
      ...
      this.girl = this.add.image(-300, 465, "Lexi2");
      this.choose = this.add.image(300, 35, "Choose-dress").setAlpha(0);
      this.clothes1 = this.add.image(160, 700, "dress1").setAlpha(0);
      this.clothes2 = this.add.image(440, 700, "dress2").setAlpha(0);
    ...
    clothesFn() {
      ...
      if (this.scale.orientation === Phaser.Scale.PORTRAIT) {
        this.progress = this.add.image(300, 30, "progress").setAlpha(0);
      } else {
        this.progress = this.add
          .image(300, 265, "progress")
          .setScale(0.45)
          .setAlpha(0);
      }
